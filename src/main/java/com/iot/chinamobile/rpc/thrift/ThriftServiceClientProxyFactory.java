...
import com.iot.chinamobile.rpc.thrift.ThriftClientPoolFactory.PoolOperationCallBack;
...
public class ThriftServiceClientProxyFactory implements FactoryBean, InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		final ThriftClientPoolFactory clientPool = new ThriftClientPoolFactory(serverAddressProvider, clientFactory, callback);
		...
		proxyClient = Proxy.newProxyInstance(classLoader, new Class[] { objectClass }, new InvocationHandler() {
			...
			public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
				...
				if (!clientPool.validateObject(client)) {
					client = clientPool.makeObject();
				}
				try {
